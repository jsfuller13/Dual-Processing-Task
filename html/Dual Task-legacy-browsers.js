...
function B1LoopBegin(thisScheduler) {
  ...
  trialIterator = B1[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB1 = result.value;
...
function B1_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = B1_trials[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB1_trial = result.value;
...
function B2_instrLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = B2_instr[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB2_instr = result.value;
...
function B3_instrLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = B3_instr[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB3_instr = result.value;
...
function B3_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = B3_trials[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisB3_trial = result.value;
...
function sound_2RoutineBegin() {
  ...
  sound_2Components.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function B1_trialRoutineBegin() {
  ...
  B1_trialComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function block_2RoutineBegin() {
  ...
  block_2Components.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function B3_trialRoutineBegin() {
  ...
  B3_trialComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
